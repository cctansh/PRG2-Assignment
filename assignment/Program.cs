...
List<Flavour> ChooseFlavours(int s)
{
...
List<Flavour> AddFlavour(string flavour, bool premium, List<Flavour> flavours)
{
    if (flavours.Count > 0)
    {
...
bool HasTopping(string topping, List<Topping> toppings)
{
    if (toppings.Count > 0)
    {
